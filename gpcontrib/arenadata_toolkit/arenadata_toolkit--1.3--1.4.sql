...
CREATE FUNCTION arenadata_toolkit.check_and_alter_tablespace_location()
RETURNS VOID
AS $$
BEGIN
...
SELECT arenadata_toolkit.check_and_alter_tablespace_location();
-- This function is needed only once, for correct update tables and view
DROP FUNCTION arenadata_toolkit.check_and_alter_tablespace_location();
